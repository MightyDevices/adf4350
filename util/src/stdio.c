...
/* scan char */
static int s_c(const char *in, char *c)
{
	int len = 0;
...
/* scan dec */
static int s_d(const char *in, int *d)
{
	int len = 0;
	int value = 0, sign = 1;
...
/* scan hex */
static int s_x(const char *in, int *x)
{
	int len = 0;
	int value = 0, sign = 1;
	/* skip whitespace*/
...
/* scan string */
static int s_s(const char *in, char *s)
{
	int len = 0;
	/* skip whitespace */
	while (*in && is_space(*in)) {
...
/* simple sscanf */
int sscanf(const char *in, char *fmt, ...)
{
	va_list argp;
	int count = 0, _len;
